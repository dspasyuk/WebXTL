...
-   **Validation against COD**: `npm test` downloads curated **Crystallography Open Database** entries (14 structures across all crystal systems) and checks that the determined space group matches the published one (`tests/xrdspace-cod.js`, cached in `HKLs/cod/`).
