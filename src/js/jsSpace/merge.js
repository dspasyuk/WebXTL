// Reflection merging and output generation for jsSpace.
//
...
export function writeXdsAscii(merged, header = {}) {
    ...
    out.push(`!OUTPUT_FILE=${header.outputFile || 'MERGED.HKL'}        DATE=${dateStr}`);
    out.push(`!Generated by jsSpace (WebXTL)`);
